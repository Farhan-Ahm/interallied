...
const PRODUCTS = [
  { id: 1,  name: 'PT-400',     category: 'Power Transformers', image: '/products/pt-400.jpeg',   specs: ['Category: Power Transformers','Capacity: 25-400 kVA', 'Types: Dry/Oil-Immersed', 'Voltage: 240/480/600','Installation: Pole-Mounted, Pad-Mounted/Underground, Underground/Submersible','Standard: CEC/CSA C22.1/ANSI','Gauge Selection: Liquid, Temperature, Pressure'] },
  { id: 2,  name: 'PT-2000',     category: 'Power Transformers', image: '/products/pt-2000.png',   specs: ['Category: Power Transformers','Capacity: 500-2000 kVA',   'Types: Dry/Oil-Immersed', 'Voltage: 240/480/600','Installation: Pole-Mounted, Pad-Mounted/Underground, Underground/Submersible','Standard: CEC/CSA C22.1/ANSI','Gauge Selection: Liquid, Temperature, Pressure'] },
  { id: 3,  name: 'PT-5000',    category: 'Power Transformers', image: '/products/pt-5000.png',  specs: ['Category: Power Transformers','Capacity: ⁠2500-5000 kVA',  'Types: Dry/Oil-Immersed', 'Voltage: 240/480/600','Installation: Pole-Mounted, Pad-Mounted/Underground, Underground/Submersible','Standard: CEC/CSA C22.1/ANSI','Gauge Selection: Liquid, Temperature, Pressure'] },
  { id: 4,  name: 'PT-ULM',    category: 'Power Transformers', image: '/products/pt-g5000.jpeg',  specs: ['Category: Power Transformers','Capacity: ⁠>5000 kVA',  'Types: Dry/Oil-Immersed', 'Voltage: 240/480/600','Installation: Pole-Mounted, Pad-Mounted/Underground, Underground/Submersible','Standard: CEC/CSA C22.1/ANSI','Gauge Selection: Liquid, Temperature, Pressure'] },
  
  
  { id: 5,  name: 'LV-SWG-A',  category: 'LV Switchgear',      image: '/products/lv-swg.png',  specs: ['Category: Low Voltage (LV) Switchgear','Voltage: ≤1000V AC/DC','Amp: 100A to 6,300A', 'Type: MDB / MCC / ATS / Panelboards', 'Typical breakers: MCB / MCCB / ACB','Safety Standards: CSA/CEC/ANSI/IEEE/IEC/NEC','Application: End-User (Buildings)'] },
  { id: 6,  name: 'MV-SWG-B',  category: 'MV Switchgear',      image: '/products/mv-swg.png',  specs: ['Category: Medium Voltage (LV) Switchgear','Voltage: 1kV – 36kV AC/DC', 'Amp: 600A to 4,000A','Type: Metal-Clad/GIS/AIS/RMU/2S', 'Typical Breakers: VCBs, SF6 Circuit-Breakers, ACB, OCB, Solid-State MVDC','Safety Standards: CSA/CEC/ANSI/IEEE/IEC/NEC','Application: Primary Distribution'] },
  { id: 7,  name: 'HV-SWG-C',  category: 'HV Switchgear',      image: '/products/hv-swg.png',  specs: ['Category: High Voltage (LV) Switchgear','Voltage: >36kV AC/DC', 'Amp: >6,300A','Type: AIS/GIS/GCB', 'Typical Breakers: SF6 Circuit-Breakers, Vacuum, ABCB, Oil, Air','Safety Standards: CSA/CEC/ANSI/IEEE/IEC/NEC','Application: Grid Transmission'] },
  
  { id: 8,  name: 'MSB-SWB-A', category: 'Switchboards',       image: '/products/msb-swb.png', specs: ['Primary Power Distribution Panel', 'Typical components: ACB / Busbar / Metering','Coordination Type: Type-1 or Type-2','Access: Front/Rear','Location: NEMA 1 or NEMA 3R','Separation: Form 1, 2a/b, 3a/b, 4a/b','Standards:  Primarily UL 891, CSA C22.2 No. 244 (Canada), and IEC 61439'] },
  { id: 9, name: 'DIS-SWB-A', category: 'Switchboards',       image: '/products/dis-swb.jpg', specs: ['Distribution Switchboards', 'Types: MDB / SDB / FDB','Coordination Type: Type-1 or Type-2','Access: Front/Rear','Location: NEMA 1 or NEMA 3R','Separation: Form 1, 2a/b, 3a/b, 4a/b','Standards:  Primarily UL 891, CSA C22.2 No. 244 (Canada), and IEC 61439'] },
  { id: 10, name: 'MCT-SWB-A', category: 'Switchboards',       image: '/products/mct-swb1.png', specs: ['Motor Control Switchboards', 'Types: MCC / VFD / Soft Starter','Coordination Type: Type-1 or Type-2','Access: Front/Rear','Location: NEMA 1 or NEMA 3R','Separation: Form 1, 2a/b, 3a/b, 4a/b','Standards:  Primarily UL 891, CSA C22.2 No. 244 (Canada), and IEC 61439'] },
];
